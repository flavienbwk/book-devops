...
De nombreuses organisations ont déjà entamé leur transformation numérique pour gagner en efficacité. Le DevOps constitue l'une des approches permettant d'atteindre cet objectif. Ce mouvement culturel et organisationnel ayant fait son apparition dès 2007 permet aux parties-prenantes d'une organisation de travailler plus efficacement, pour atteindre ses objectifs plus rapidement et de manière pérenne.

Le DevOps s'inscrit dans la dynamique d'explosion des usages du numérique pour tous les types de structures. Il implique pour les entreprises de répondre au besoin opérationnel toujours plus vite et de manière sécurisée, pour garder une longueur d'avance face à une concurrence toujours plus féroce. Ce mode d'organisation approche cet enjeu en proposant des méthodologies, pour transformer les organisations qui souhaitent améliorer la qualité de leurs services. Pour permettre aux organisations d'être plus agiles, il tire pleinement bénéfice des technologies Cloud : résilientes et attractives.
...
Si vous avez l'impression d'avoir déjà entendu cela et que vous lisez ce livre, ces paroles ont probablement suscité pour vous un sentiment de consternement.
